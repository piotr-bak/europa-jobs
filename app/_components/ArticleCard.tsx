...
export function ArticleCard( { title, href, mediaUrl, date, tags }: ArticleCard ) {
    return (
        <article className="flex p-0.5 rounded-xl overflow-hidden bg-white flex-col">
            <div className='w-full'>
                <figure className="relative w-full h-64">
                    ...
                    />
                    <div className="absolute inset-0 bg-black opacity-55 z-10 rounded-t-lg rounded-b"></div>
